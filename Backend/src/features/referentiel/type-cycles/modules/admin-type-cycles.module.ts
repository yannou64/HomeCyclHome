...
@Module({
    ...
    providers: [
        { provide: TYPE_CYCLES_REPO, useClass: TypeCyclesPrismaRepository },
        {
            ...
            useFactory: (repo: TypeCyclesPrismaRepository) =>
                new GetTypeCyclesUseCase(repo),
            inject: [TYPE_CYCLES_REPO],
        },
        {
            provide: CreateTypeCycleUseCase,
            useFactory: (repo: TypeCyclesPrismaRepository) =>
                new CreateTypeCycleUseCase(repo),
            inject: [TYPE_CYCLES_REPO],
        },
        {
            provide: UpdateTypeCycleUseCase,
            useFactory: (repo: TypeCyclesPrismaRepository) =>
                new UpdateTypeCycleUseCase(repo),
            inject: [TYPE_CYCLES_REPO],
        },
        {
            provide: DeleteTypeCycleUseCase,
            useFactory: (repo: TypeCyclesPrismaRepository) =>
                new DeleteTypeCycleUseCase(repo),
            inject: [TYPE_CYCLES_REPO],
        },
    ],
})
